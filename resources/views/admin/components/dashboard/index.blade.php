            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Dubai</span>
                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-success">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Riyadh</span>
                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-warning">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Jeddah</span>
                            <span class="info-box-number">{{number_format($web)}}</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Doha</span>
